...
UNION
SELECT UNIX_TIMESTAMP(time_stamp) as epoch, image_num, runtime, pred_total, pred_transfer, pred_deploy, pred_proc,
act_total, act_transfer, act_deploy, act_proc from LogTime where task_id > 3266 and task_id < 3531
INTO OUTFILE '/var/lib/mysql-files/logTime_stoic.csv' FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\n';
